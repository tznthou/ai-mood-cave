...
export const CONSTANTS = {
    ...
    MAX_RECORDS: 100,
    CLEANUP_INTERVAL: 60 * 60 * 1000, // 1小時
    RECORD_EXPIRY: 24 * 60 * 60 * 1000, // 24小時
    REQUEST_TIMEOUT: 30000, // 30秒
    AI_REQUEST_TIMEOUT: 10000, // 10秒
    DEBOUNCE_DELAY: 100, // 防抖延遲
    RETRY_ATTEMPTS: 3, // 重試次數
    RETRY_DELAY_BASE: 1000 // 重試基礎延遲
};
...
export const responseTemplates = {
    ...
    meditation: [
        "讓我們先停下來，深深地呼吸一下。感受你現在的{mood}，不要抗拒它，只是靜靜地觀察。情緒就像雲朵，它們會來，也會走。讓我們一起找到內心的平靜。",
...
export const aiResponses = {
    ...
    mentor: {
        ...
        neutral: [
            "平靜的心境是智慧的開始。 在這種狀態下，你可以更清晰地思考和觀察。建議你利用這個時機進行自我反思：你的價值觀是什麼？你想要成為什麼樣的人？這些平靜的時刻往往最有價值。",
    ...
    meditation: {
        ...
        negative: [
            ...
            "在這個困難的時刻，讓我們尋找內在的寧靜... 想像你的心中有一盞永不熄滅的明燈，無論外在如何風雨，這盞燈都在靜靜燃燒。深呼吸，連結這份內在的力量，你比你想像的更堅強。"
        ],
        neutral: [
            "在這份寧靜中，讓我們練習正念... 感受此刻的存在，不需要改變什麼，只需要純粹地覺察。你的思緒如雲朵般飄過心空，觀察它們，但不被它們帶走。在這份覺察中，找到真正的自由。",
...
export const suggestions = {
    positive: [
        { icon: '<i class="fas fa-edit"></i>', text: '記錄這個美好時刻，創建一個快樂日記' },
        { icon: '<i class="fas fa-heart"></i>', text: '分享你的快樂給身邊的人' },
        { icon: '<i class="fas fa-bullseye"></i>', text: '設定新的目標，趁著好心情前進' },
        { icon: '<i class="fas fa-dumbbell"></i>', text: '嘗試新的挑戰或學習新技能' }
    ],
    negative: [
        { icon: '<i class="fas fa-leaf"></i>', text: '嘗試5分鐘的深呼吸或冥想練習' },
        { icon: '<i class="fas fa-walking"></i>', text: '到戶外走走，接觸大自然' },
        { icon: '<i class="fas fa-users"></i>', text: '聯繫信任的朋友或家人' },
        { icon: '<i class="fas fa-music"></i>', text: '聽一些舒緩的音樂' },
        { icon: '<i class="fas fa-phone"></i>', text: '如果感到嚴重困擾，考慮尋求專業協助' }
    ],
    neutral: [
        { icon: '<i class="fas fa-book"></i>', text: '閱讀一本有趣的書籍' },
        { icon: '<i class="fas fa-palette"></i>', text: '嘗試創意活動，如畫畫或寫作' },
        { icon: '<i class="fas fa-leaf"></i>', text: '進行正念練習，觀察當下' },
        { icon: '<i class="fas fa-clipboard-list"></i>', text: '整理思緒，制定近期計劃' }
    ]
};
